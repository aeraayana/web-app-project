...
import { ButtonSolid, Hyperlink, Spacing } from "../../../components";
                            ...
                            <div id="progress-bar" className="row-start-start w-full">
                                ...
                                <div className="col-start-start">
                                    ...
                                    <div className="col-start-start">
                                        <span className="page-number">TAHAP 2</span>
                                        <span className="subtitle">Informasi pencairan dana</span>
                                        <ButtonSolid height={'2.25rem'} onClick={handleOpen} disabled={(parseInt(dataProgress?.data[0]?.tahapan_pengajuan) !== 3)} label={'Form Pencairan Dana'} width={'12rem'}/>
                                    </div>
                                </div>
                            </div>
                        </div>
