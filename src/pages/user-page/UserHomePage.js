...
import DOCPerjanjian from '../../assets/LDML_Perjanjian Kontrak Kerjasama.docx';
import DOCTanggungJawab from '../../assets/LDML_Dokumen Pertanggung Jawaban.docx'
            ...
            <Wrapper className='col-start-start w-full h-full' style={{ height: '100vh' }}>
                ...
                <div className='row-between-center price-tag w-full' style={{ width: '70%' }}>
                    <div className='row-start-center'>
                        ...
                        <Spacing width={'1.25rem'}/>
                        <div className='col-start-start'>
                            <a href={DOCTanggungJawab} className='label'>Perjanjian Kontrak Kerjasama</a>
                            <Spacing height={'0.45rem'}/>
                            <span>1.8 KB</span>
                        </div>
                    </div>
