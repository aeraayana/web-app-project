...
import Pana from "../../../assets/images/landing/Vector.png";
...
const Wrapper = styled.div`
    ...
    input[type="checkbox"] + label::before {
        ...
        height: 2ex;
        width: 2ex;
        background-image: url('src/assets/images/landing/pana.png');
...
const RadioChoiceBoxWithImagePrompt = ({ prompt, color, type, options, name, onChange, errorMessage, className, width, onBlur, value }) => {
...
export default RadioChoiceBoxWithImagePrompt
